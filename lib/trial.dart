...
//     // Create a new list to store processed messages
//     List<dynamic> processedMessages = [];

//     // Iterate through messages and remove 'share' field if it exists
//     for (var message in messages) {
//       // Create a copy of the message to avoid modifying the original
//       var processedMessage = Map<String, dynamic>.from(message);

//       // Remove 'share' field if it exists
//       if (processedMessage.containsKey('share')) {
//         processedMessage.remove('share');
//       }

//       // Add processed message to the list
...
//     // Initialize message count for each participant
//     for (var participant in participants) {
//       messageCount[participant['name']] = 0;
//       averageResponseTime[participant['name']] = 0.0;
//     }

//     // Categorize messages into participant-specific lists
//     for (var message in messages) {
...
//             // Accumulate response time and count responses
...
//               child: Text('Open JSON File Picker'),
//             ),
//             SizedBox(height: 20),
//             Text(
//               'Message Counts:',
